...
@section('title', translate('add_new_Selling_Point'))
@push('css_or_js')
...
<div class="content container-fluid main-card {{Session::get('direction')}}">
    <div class="mb-4">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{ translate('add_new_Selling_Point') }}
        </h2>
    </div>
    <form class="user" action="{{route('admin.selling-points.add')}}" method="post" enctype="multipart/form-data" id="add-points-form">
        @csrf
        <div class="card">
            <div class="card-body">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2 border-bottom pb-3 mb-4 pl-4">
                    <img src="{{dynamicAsset(path: 'public/assets/back-end/img/vendor-information.png')}}" class="mb-1" alt="">
                    {{translate('selling_Point_information')}}
                </h5>

                <div class="row">
                    <div class="col-lg-6 form-group">
                        <label for="shop_name" class="title-color d-flex gap-1 align-items-center">{{translate('selling_point_name')}}</label>
                    ...
                    <div class="col-lg-6 form-group">
                        <label for="shop_address" class="title-color d-flex gap-1 align-items-center">{{translate('selling_point_address')}}</label>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="mt-4">
                            <div class="d-flex gap-1 align-items-center title-color mb-2">
                                {{translate('selling_point_banner')}}
                ...
                <input type="hidden" name="is_selling_point" value="1">
                <div class="d-flex align-items-center justify-content-end gap-10">
                    ...
                    <button type="button" class="btn btn--primary btn-user form-submit" data-form-id="add-points-form" data-redirect-route="{{route('admin.selling-points.points-list')}}"
                            data-message="{{translate('want_to_add_this_Selling_Point').'?'}}">{{translate('submit')}}</button>
                </div>
            </div>
        </div>
    </form>
