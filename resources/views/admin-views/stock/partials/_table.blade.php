        ...
        <div class="table-responsive pos-cart-table border">
            <table class="table table-align-middle m-0">
                ...
                <tr>
                    ...
                    <th class="border-0">{{ translate('Unit price') }}</th>
                ...
                @foreach($cartItems['cartItemValue'] as $key => $item)
                    @if(is_array($item))
                        <tr>
                            ...
                            <td>
                                <div>
                                    {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount:($item['productSubtotal']/$item['quantity'])), currencyCode: getCurrencyCode()) }}
                                </div>
                            </td>
                            <td>
                                <div>
