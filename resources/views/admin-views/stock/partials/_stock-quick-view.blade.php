        ...
        <div class="col-md-5">
            ...
            <div class="d-flex flex-column gap-10 fz-14 mt-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div id="product-code">{{ $product->code }}</div>
                </div>
...
{{--                        <input type="hidden" id="variation-count" value="{{$isEmpty}}">--}}
{{--                        @php--}}
{{--                            $myCount=false;--}}
{{--                            if(!empty($product->variation)){--}}
{{--                               $myCount  = true;--}}
{{--                            }--}}
{{--                         @endphp--}}
{{--                        <input type="hidden" id="variation-count" value="{{$myCount}}">--}}
                        @if(!empty($product->variation))
                            <div id="variation">
                                <select name="variations" id="variations" class="form-control">
                                    @foreach (json_decode($product->variation) as $key => $variation)
                                        <option value="{{$variation->sku}}">{{$variation->type}}</option>
                                    @endforeach
                                </select>
                            </div>
                        @endif
...
{{--                        <button class="btn btn--primary btn-block quick-view-modal-add-cart-button my-add-to-cart" type="button">--}}
