...
{{--    <div class="offer-bar py-3 announcement-color" data-bg-img="{{theme_asset('assets/img/media/top-offer-bg.png')}}">--}}
    <div class="offer-bar py-1 announcement-color mb-1">
        <div class="d-flex gap-2 align-items-center">
            <div class="top-offer-text flex-grow-1 d-flex justify-content-center fs-12">
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between gap-3">
                <div class="w-50" style="margin-left:20px">
                    <ul class="list-socials list-socials--white gap-4 fs-13">
                                ...
                                <li>
                                    @if ($item->name == "twitter")
                                        <a href="{{$item->link}}" target="_blank" class="font-bold">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16"
                                                ...
                                                <g opacity=".3">
                                                    <polygon fill="#000" fill-rule="evenodd"
                                    ...
                                    @elseif($item->name == 'google-plus')
                                        <a href="{{$item->link}}" target="_blank">
                                            <i class="bi bi-google" style="color: #baa75e "></i>
                                        </a>
                                    @else
                                        <a href="{{$item->link}}" target="_blank">
                                            <i class="bi bi-{{$item->name}}" style="color: #baa75e"></i>
                                        </a>
                                    @endif
                                </li>
                            @endforeach
...
{{--                </div>--}}
                <div class="w-50">
                    <ul class="d-flex justify-content-xl-end list-unstyled gap-4 mb-0 pe-2">
                        @if(auth('customer')->check())
                            <li class="login-register d-flex align-items-center gap-4" style="color: green">
...
{{--                                        class="border-0 bg-transparent d-flex gap-2 align-items-center dropdown-toggle text-dark p-0 user"--}}
                                    ...
                                    <ul class="dropdown-menu bs-dropdown-min-width--10rem">
                                        <li><a style="color: var(--bs-primary)" href="{{route('account-oder')}}">{{ translate('my_order') }}</a></li>
                                        <li><a style="color: var(--bs-primary)" href="{{route('user-profile')}}">{{ translate('my_profile') }}</a></li>
                                        <li><a style="color: var(--bs-primary)" href="{{route('customer.auth.logout')}}">{{ translate('logout') }}</a></li>
                                    </ul>
                                </div>
                                <div class="menu-btn d-xl-none">
                                    <i class="bi bi-list fs-30" style="color: var(--bs-primary)"></i>
                                </div>
                            </li>
                        @else
                            <li class="login-register d-flex gap-4">
                                ...
                                <span class="avatar header-avatar rounded-circle d-xl-none size-1-5rem">
                                    ...
                                    <i class="bi bi-person fs-16" style="color: var(--bs-primary)"></i>
                                    <span
                                        class="media-body d-none d-xl-block hover-primary" style="color: var(--bs-primary)">{{ translate('login')}}
                                    </span>
                                </button>
                                <div class="menu-btn d-xl-none">
                        ...
                        <li class="d-none d-xl-block">
                            @if(auth('customer')->check())
                                <a href="{{ route('product-compare.index') }}" class="position-relative">
                                    <i class="bi bi-repeat fs-14" style="color: var(--bs-primary)"></i>
                                    <span
                        ...
                        <li class="d-none d-xl-block">
                            @if(auth('customer')->check())
                                <a href="{{ route('wishlists') }}" class="position-relative">
                                    <i class="bi bi-heart fs-14" style="color: var(--bs-primary)"></i>
                                    <span
...
{{--                        </ul>--}}
            ...
            <div class="d-flex justify-content-between gap-3 align-items-center position-relative mt-3">
...
{{--                        </div>--}}
                        <ul class="nav main-menu align-items-center d-none d-xl-flex flex-nowrap" >
                            <li class="{{request()->is('/shop')?'active':''}}">
                                <a class="cursor-pointer" style="color: var(--bs-primary)" href="{{route('shop')}}">{{ translate('Shop')}}</a>
{{--                                <ul class="sub-menu megamenu p-3 bs-dropdown-min-width--max-content">--}}
{{--                                    @if($categories)--}}
{{--                                        @foreach($categories as $key=>$category)--}}
{{--                                            @if($key<8)--}}
{{--                                                <li class="{{ $category->childes->count() > 0 ? 'menu-item-has-children':'' }}">--}}
{{--                                                    <a style="color: var(--bs-primary)" href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">--}}
{{--                                                        {{$category['name']}}--}}
{{--                                                    </a>--}}
{{--                                                    @if ($category->childes->count() > 0)--}}
{{--                                                        <ul class="sub-menu">--}}
{{--                                                            @foreach($category['childes'] as $subCategory)--}}
{{--                                                                <li class="{{ $subCategory->childes->count()>0 ? 'menu-item-has-children':'' }}">--}}
{{--                                                                    <a style="color: var(--bs-primary)" href="{{route('products',['id'=> $subCategory['id'],'data_from'=>'category','page'=>1])}}">--}}
{{--                                                                        {{$subCategory['name']}}--}}
{{--                                                                    </a>--}}
{{--                                                                    @if($subCategory->childes->count()>0)--}}
{{--                                                                        <ul class="sub-menu">--}}
{{--                                                                            @foreach($subCategory['childes'] as $subSubCategory)--}}
{{--                                                                                <li>--}}
{{--                                                                                    <a style="color: var(--bs-primary)" href="{{route('products',['id'=> $subSubCategory['id'],'data_from'=>'category','page'=>1])}}">--}}
{{--                                                                                        {{$subSubCategory['name']}}--}}
{{--                                                                                    </a>--}}
{{--                                                                                </li>--}}
{{--                                                                            @endforeach--}}
                            ...
                            @if($web_config['featured_deals']->count()>0 || $web_config['flash_deals'])
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        @if($web_config['featured_deals']->count()>0)
                                            <li>
                                                <a style="color: var(--bs-primary)" class="text-capitalize"
...
{{--                            @if($web_config['business_mode'] == 'multi')--}}
{{--                                <li>--}}
{{--                                    <a class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('stores') }}</a>--}}
{{--                                    <div--}}
...
{{--                                                    @foreach($web_config['shops'] as $shop)--}}
{{--                                                        <a style="color: var(--bs-primary)" href="{{route('shopView',['id'=>$shop['id']])}}"--}}
{{--                                                           class="media gap-3 align-items-center border-bottom">--}}
{{--                                                            <div class="avatar rounded size-2-5rem">--}}
{{--                                                                <img loading="lazy" alt="{{ translate('image') }}"--}}
...
{{--                            @if($web_config['brand_setting'])--}}
{{--                                <li>--}}
{{--                                    <a class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('brands') }}</a>--}}
{{--                                    <div class="sub-menu megamenu p-3 bs-dropdown-min-width--max-content">--}}
{{--                                        <div class="d-flex gap-4">--}}
{{--                                            <div class="column-2">--}}
{{--                                                @foreach($brands as $brand)--}}
{{--                                                    <a style="color: var(--bs-primary)" href="{{ route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1]) }}"--}}
{{--                                                       class="media gap-3 align-items-center border-bottom">--}}
...
{{--                            @if ($web_config['discount_product']>0)--}}
{{--                                <li class="">--}}
{{--                                    <a style="color: var(--bs-primary)" class="d-flex gap-2 align-items-center discount-product-menu {{request()->is('/')?'active':''}}"--}}
{{--                                       href="{{route('products',['data_from'=>'discounted','page'=>1])}}">--}}
{{--                                        {{ translate('discounted_products') }}--}}
{{--                                        <i class="bi bi-patch-check-fill text-warning"></i>--}}
{{--                                    </a>--}}
...
{{--                            @endif--}}
                                ...
                                <li>
                                    <a href="{{route('categories_prottyashi')}}" class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('collections') }}</a>
                                    <ul class="sub-menu megamenu p-3 bs-dropdown-min-width--max-content">
                                        @if($categories)
                                            @foreach($categories as $key=>$category)
                                                @if($key<8)
                            ...
                            <li>
                                <a class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('about') }}</a>
                            </li>
{{--                            <li>--}}
{{--                                <a class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('inspiration') }}</a>--}}
{{--                            </li>--}}
                            <li>
                                <a class="cursor-pointer" style="color: var(--bs-primary)">{{ translate('blog') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <form action="{{route('products')}}" class="mb-3">
                        <div class="d-flex border border-primary" style="border: var(--bs-primary); border-radius: 3px; ">
                            <input type="search" name="name" class="form-control search-bar-input-mobile border-0"
                                   autocomplete="off" placeholder="{{ translate('search_for_items').'...' }}">
                            <input name="data_from" value="search" hidden="">
                            <input name="page" value="1" hidden="">
                            <button type="submit" class="border-0 bg-transparent">
                                <i style="color: var(--bs-primary)" class="bi bi-search"></i>
                            </button>
                        </div>
                        <div
                            class="card search-card __inline-13 position-absolute z-99 w-100 bg-white start-0 search-result-box d--none"></div>
