...
{{--                </div>--}}
    ...
    <div class="footer-main px-2  px-lg-0 mb-5">
        <div class="container">
            <div class="row gy-5">
{{--                <div class="col-lg-4">--}}
{{--                    <div class="widget widget--about text-center text-lg-start absolute-white" >--}}
{{--                        <p style="color: var(--text-color-dark)">{{ getWebConfig(name: 'shop_address')}}</p>--}}
{{--                        <a style="color: var(--text-color-dark)" href="mailto:{{$web_config['email']->value}}">{{$web_config['email']->value}}</a>--}}
...
{{--                SHOP WITH US--}}
                <div class="col-sm-3 col-6">
                    <div class="widget widget--nav absolute-white">
                        <h4 class="widget__title text-uppercase" style="color: var(--bs-primary); font-weight: normal">{{translate('shop_with_us')}}</h4>
                        <ul class="d-flex flex-column gap-3">
{{--                            <li>--}}
{{--                                <a class="text-capitalize" style="color: var(--text-color-dark); font-size: smaller" href="{{route('about-us')}}">{{translate('about_company')}}</a>--}}
{{--                            </li>--}}
                            <li><a class="text-capitalize" style="color: var(--text-color-dark); font-size: smaller"
                            ...
                            @if(isset($web_config['refund_policy']['status']) && $web_config['refund_policy']['status'] == 1)
                                <li>
                                    <a class="text-capitalize" style="color: var(--text-color-dark); font-size: smaller"
                            ...
                            <li>
                                ...
                                @else
                                    <button class="bg-transparent border-0 p-0 text-capitalize" style="color: var(--text-color-dark); font-size: smaller"
                ...
                <div class="col-sm-3 col-6">
                    <div class="widget widget--nav absolute-white">
                        <h4 class="widget__title text-uppercase" style="color: var(--bs-primary); font-weight: normal">{{translate('accounts')}}</h4>
                        <ul class="d-flex flex-column gap-3 ">
                            ...
                            <li>
                                @if(auth('customer')->check())
                                    <a href="{{route('user-profile')}}" style="color: var(--text-color-dark); font-size: smaller">{{translate('profile')}}</a>
                                @else
                                    <button class="bg-transparent border-0 p-0" data-bs-toggle="modal" style="color: var(--text-color-dark); font-size: smaller"
                ...
                <div class="col-sm-3 col-6">
                    <div class="widget widget--nav absolute-white">
                        <h4 class="widget__title text-uppercase" style="color: var(--bs-primary); font-weight: normal">{{translate('special')}}</h4>
                        <ul class="d-flex flex-column gap-3">
                            ...
                            <li><a href="{{route('helpTopic')}}" style="color: var(--text-color-dark); font-size: smaller">{{translate('FAQ')}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3 col-6">
                    <div class="widget widget--nav absolute-white">
                        <h4 class="widget__title text-uppercase" style="color: var(--bs-primary); font-weight: normal">{{translate('share_with_us')}}</h4>
                        <ul class="d-flex flex-column gap-3">

                            <li>
                                <span class="text-capitalize" style="color: var(--text-color-dark); font-size: smaller">{{translate('share_the_love!')}}</span>
                            </li>

                            <li>
                                <span  style="color: var(--text-color-dark); font-size: smaller">{{translate('#prottyashi')}}</span>
                            </li>
                            <li><span  style="color: var(--text-color-dark); font-size: smaller">{{translate('Tag_us_@prottyashi')}}</span></li>
                            <li>
...
{{--                </div>--}}
    ...
    <div class="absolute-dark">
        <div class="container">
            <div class="text-left copyright-text mb-5" style="font-size: smaller">
                © {{ $web_config['copyright_text']->value }}.Powered by Moulik Solutions
            </div>
        </div>
    </div>
</footer>
