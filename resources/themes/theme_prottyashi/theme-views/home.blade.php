...
{{--        </section>--}}
        ...
        @include('theme-views.partials._newsletter')
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var elements = document.getElementsByName("subscription_email");
        for (var i = 0; i < elements.length; i++) {
            elements[i].oninvalid = function(e) {
                e.target.setCustomValidity("");
                if (!e.target.validity.valid) {
                    e.target.setCustomValidity("Please provide your email to continue");
                }
            };
