<?php
namespace App\Http\Controllers\Admin\SellingPoint;
...
class SellingPointController extends Controller
{
    ...
    {
        return view('admin-views.selling-point.add-new-point');
    }
    ...
    public function add(VendorAddRequest $request): JsonResponse
    {
        ...
        $data = [
            'name' => $request['f_name'],
            'status' => 'pending',
            'subject' => translate('Selling_Point_Registration_Successfully_Completed'),
        ...
        return response()->json(['message' => translate('selling_point_added_successfully')]);
    }
